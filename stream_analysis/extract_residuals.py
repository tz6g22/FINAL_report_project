...
This script reads a pre-built analysis set (from ``stream_analysis/make_analysis_set.py``),
...
::
    ...
    python stream_analysis/extract_residuals.py \\
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to an analysis-set .pt file generated by stream_analysis/make_analysis_set.py.",
    )
